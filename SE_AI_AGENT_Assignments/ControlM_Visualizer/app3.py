...
<style>
    ...
    /* This targets the Vis.js navigation icons specifically */
    ...
    if not df_jobs.empty:
        ...
        with col5:
             if not unlimited:
                 ...
                 depth_limit = None # Python 'None' signals unlimited recursion
