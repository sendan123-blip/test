...
def render_pyvis_html(G, search_list, theme_cfg):
    ...
    options_dict = {
        ...
        # Disable default UI, we inject our own
    ...
    <style>
        ...
        .ui-btn:hover {{
            background: #007bff; /* Premium Blue Hover */
            border-color: #0056b3;
        ...
        /* Light Mode Adjustment Override */
        /* If background is white, we might want darker buttons, but white icons on dark bg looks best universally */
    </style>
